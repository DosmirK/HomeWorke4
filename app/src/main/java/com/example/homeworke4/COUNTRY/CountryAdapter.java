...
import com.example.homeworke4.databinding.ItemCountryBinding;
...
class CountryViewHolder extends RecyclerView.ViewHolder {
    ...
    public void onBind(CountryModel countryModel) {
        binding.tvCountryName.setText(countryModel.getName());
        Glide.with(binding.imgCountry).load(countryModel.getPoster()).into(binding.imgCountry);
    }
}
